...
namespace BTBackendOnline2.Migrations
{
    ...
    [Migration("20250217053533_update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTBackendOnline2.Models.AllowAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("AccessPropertiesJson")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BTBackendOnline2.Models.Intern", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BTBackendOnline2.Models.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BTBackendOnline2.Models.User", b =>
                {
            ...
            modelBuilder.Entity("BTBackendOnline2.Models.AllowAccess", b =>
                {
                    b.HasOne("BTBackendOnline2.Models.Role", "Role")
            ...
            modelBuilder.Entity("BTBackendOnline2.Models.User", b =>
                {
                    b.HasOne("BTBackendOnline2.Models.Role", "Role")
                        .WithOne("User")
                        .HasForeignKey("BTBackendOnline2.Models.User", "RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
